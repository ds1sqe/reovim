...
use crate::window::{NavigateDirection, Rect, WindowId};
...
mod tests {
    ...
    fn test_window_view_new() {
        let view = WindowView::new(WindowId::new(1), Rect::new(10, 20, 30, 40));
        assert_eq!(view.window_id, WindowId::new(1));
    ...
    fn test_window_view_contains() {
        let view = WindowView::new(WindowId::new(1), Rect::new(10, 10, 20, 20));
    ...
    fn test_single_window_layout_one() {
        let layout = SingleWindowLayout;
        let views = layout.arrange((80, 24), &[WindowId::new(1)]);
        assert_eq!(views.len(), 1);
        assert_eq!(views[0].window_id, WindowId::new(1));
    ...
    fn test_single_window_layout_multiple() {
        let layout = SingleWindowLayout;
        let views = layout.arrange((80, 24), &[WindowId::new(1), WindowId::new(2)]);
