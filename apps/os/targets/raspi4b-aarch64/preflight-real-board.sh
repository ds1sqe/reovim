...
write_evidence_seed() {
...

    {
        ...
        printf -- '- [ ] `cd /dev` / `cat uart0` prove relative VFS device-file access.\n'
        printf -- '- [ ] `input=usb-keyboard+uart-fallback`\n'
        printf -- '- [ ] `usb_keyboard=ready`\n'
        printf -- '- [ ] `status` / `input` report live ready source diagnostics.\n'
        printf -- '- [ ] `cat /boot/status` / `cat /boot/input` report VFS-backed live diagnostics.\n'
