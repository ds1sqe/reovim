...
///
/// ```
/// use reovim_driver_text_input::OperatorArgs;
///
...
///
/// ```ignore
/// use reovim_driver_text_input::{ResolveInput, KeyLookupState, ResolveResult};
///
...
///
/// ```ignore
/// use reovim_driver_text_input::{ModeKeyResolver, ResolveResult, KeyEvent, ModeState};
...
pub trait ModeKeyResolver: Send + Sync {
    ...
    ///
    /// ```ignore
    /// use reovim_driver_text_session::{SessionApiDyn, ModeApi, BufferApi, ExtensionMap};
    ///
...
///
/// ```ignore
/// use reovim_driver_text_input::{ResolveResult, InputTarget};
///
...
pub enum ResolveResult {
    ...
    ///
    /// ```ignore
    /// use reovim_driver_text_input::ResolveResult;
    ///
    /// // Insert mode → buffer
    /// ResolveResult::insert_char('x');
    ///
