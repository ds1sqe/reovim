...
//!
//! ```ignore
//! use reovim_content_codec_xxd::XxdCodec;
//!
...
use {
    reovim_content_codec::{CodecError, CodecMetadata, CodecView, ContentType, DecodeResult},
    reovim_driver_annotation::{Annotation, AnnotationKind, AnnotationPayload, AnnotationTarget},
};

mod module;
pub use module::XxdContentCodecModule;

#[cfg(feature = "dynamic")]
reovim_module_macros::declare_module!(XxdContentCodecModule);
...
impl reovim_content_codec::ContentCodec for XxdCodec {
