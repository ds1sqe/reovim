...
//!
//! Delegates to [`reovim_content_codec_xxd::XxdCodec`] for the actual
//! hex dump formatting.
...
pub use reovim_content_codec_xxd::{HEX_ADDRESS_KIND, HEX_ASCII_KIND, HEX_BYTE_KIND};
...
impl ContentCodec for HexCodec {
    fn decode(&self, raw: &[u8]) -> Result<DecodeResult, CodecError> {
        reovim_content_codec_xxd::XxdCodec::new().decode(raw)
    }
    ...
    fn translate_edit(
        ...
        match edit {
            ...
            // Domain edits and any future DecodedEdit variants (#[non_exhaustive])
...
///
/// Delegates to [`reovim_content_codec_xxd::format_xxd_dump`] with default
/// settings (16 bytes/line, 8-byte groups).
#[must_use]
pub fn format_hex_dump(raw: &[u8]) -> (String, Vec<reovim_driver_annotation::Annotation>) {
    reovim_content_codec_xxd::format_xxd_dump(raw, 16, 8)
}
