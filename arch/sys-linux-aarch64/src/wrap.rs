...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{Timespec, CLOCK_MONOTONIC, clock_gettime};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{AT_FDCWD, O_WRONLY, O_CLOEXEC, openat, write, close};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::send_nosignal;
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{AT_FDCWD, O_RDONLY, O_CLOEXEC, openat, read, close};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{EBADF, close};
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{MAP_ANONYMOUS, MAP_PRIVATE, PROT_READ, PROT_WRITE, mmap, munmap};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{AT_FDCWD, O_RDONLY, O_CLOEXEC, openat, close};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{CLOCK_MONOTONIC, Timespec, clock_gettime};
///
/// let mut ts = Timespec::default();
...
/// use reovim_arch_sys_linux_aarch64::{EAGAIN, FUTEX_WAIT, FUTEX_PRIVATE_FLAG, futex};
///
...
/// reovim_arch_sys_linux_aarch64::exit_group(0);
/// ```
...
/// reovim_arch_sys_linux_aarch64::exit(0);
/// ```
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::gettid;
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{socket, close};
/// use reovim_arch_sys_linux_aarch64::net::{AF_UNIX, SOCK_STREAM, SOCK_CLOEXEC};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{socket, bind, close, unlinkat, AT_FDCWD, AT_REMOVEDIR};
/// use reovim_arch_sys_linux_aarch64::net::{AF_UNIX, SOCK_STREAM, SOCK_CLOEXEC, SockaddrUn};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{socket, bind, listen, close, unlinkat, AT_FDCWD};
/// use reovim_arch_sys_linux_aarch64::net::{AF_UNIX, SOCK_STREAM, SOCK_CLOEXEC, SockaddrUn};
///
/// let fd = socket(AF_UNIX as usize, SOCK_STREAM | SOCK_CLOEXEC, 0).unwrap();
...
/// use reovim_arch_sys_linux_aarch64::{accept, EBADF};
...
/// use reovim_arch_sys_linux_aarch64::{socket, connect, ENOENT};
/// use reovim_arch_sys_linux_aarch64::net::{AF_UNIX, SOCK_STREAM, SOCK_CLOEXEC, SockaddrUn};
///
/// let fd = socket(AF_UNIX as usize, SOCK_STREAM | SOCK_CLOEXEC, 0).unwrap();
/// let mut sa = SockaddrUn::zeroed();
...
/// reovim_arch_sys_linux_aarch64::close(fd as i32).unwrap();
...
/// use reovim_arch_sys_linux_aarch64::{ioctl, AT_FDCWD, O_RDONLY, O_CLOEXEC, openat, close};
/// use reovim_arch_sys_linux_aarch64::term::{TCGETS, Termios};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{unlinkat, AT_FDCWD, ENOENT};
///
...
///
/// ```rust
/// use reovim_arch_sys_linux_aarch64::{unix_stream_socket, close};
///
