...
///
/// ```rust
/// use reovim_arch_sys_linux_x86_64::net::{SockaddrUn, AF_UNIX, UNIX_PATH_MAX};
///
...
impl SockaddrUn {
    ...
    ///
    /// ```rust
    /// use reovim_arch_sys_linux_x86_64::net::SockaddrUn;
    ///
    ...
    ///
    /// ```rust
    /// use reovim_arch_sys_linux_x86_64::net::{SockaddrUn, AF_UNIX};
    ///
    /// let mut sa = SockaddrUn::zeroed();
    /// sa.sun_family = AF_UNIX;
