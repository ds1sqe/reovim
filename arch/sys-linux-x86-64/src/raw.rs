...
/// use reovim_arch_sys_linux_x86_64::{syscall0, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
...
/// use reovim_arch_sys_linux_x86_64::{syscall1, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
...
/// ```ignore
/// // Prefer the typed wrappers in `crate::sys`. Direct use:
/// use reovim_arch_sys_linux_x86_64::{syscall2, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
...
/// ```ignore
/// // Prefer the typed wrappers in `crate::sys`. Direct use:
/// use reovim_arch_sys_linux_x86_64::{syscall3, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
...
/// ```ignore
/// // Prefer the typed wrappers in `crate::sys`. Direct use:
/// use reovim_arch_sys_linux_x86_64::{syscall4, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
...
/// ```ignore
/// // Prefer the typed wrappers in `crate::sys`. Direct use:
/// use reovim_arch_sys_linux_x86_64::{syscall6, from_ret};
/// use reovim_arch_sys_linux_x86_64::raw::nr;
