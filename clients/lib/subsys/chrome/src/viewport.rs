...
use reovim_client_subsys_module::{
    AnnotationContext, BufferId, ChromeSurface, ClientModule, ColorDepth, ColumnWidth, CursorInfo,
    Insets, PlatformCapabilities, Rect, RenderBehavior, RenderingModel, SelectionInfo,
    SelectionMode, Style, ThemeProvider, TokenProvider, TransformedLine, ViewportContext,
    ViewportRenderer, VirtualLine, VirtualLinePosition,
};

use crate::conceal::{ConcealDecoration, apply_conceals, dim_style, source_to_display_col};
...
impl ViewportRenderer for DefaultViewportRenderer {
