//! Client module trait family: `ClientModule`, `ModuleContext`, and supporting traits.
//!
//! The subsys crate owns the ABI contract; `reovim-client-driver` provides
//! compat re-exports.
...
pub trait ServerHandle: Send + Sync {
    ...
    #[cfg_attr(coverage_nightly, coverage(off))]
    fn get_option_metadata(&self, name: &str) -> Option<crate::types::OptionMetadata> {
        None
    }
}
