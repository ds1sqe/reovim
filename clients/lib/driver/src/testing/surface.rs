//! Minimal `ChromeSurface` fixture for driver-crate internal tests.
//!
...
//! the driver crate cannot dev-depend on `cap-cell` (that would create a
//! cyclic dev-dependency — `cap-cell` already depends on the driver crate).
//!
//! Scope: driver-crate-internal tests only. Not re-exported from
