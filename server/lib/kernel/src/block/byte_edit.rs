//! Byte-level edit type for block I/O operations.
//!
...
//! and the byte undo log records them for universal undo.
...
/// Used by the byte undo log and as the output of codec
/// `translate_edit` translation.
///
/// # Undo
///
