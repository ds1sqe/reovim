...
///
/// ```
/// use reovim_driver_text_syntax::ScopeKind;
///
...
///
/// ```
/// use reovim_driver_text_syntax::{ScopeRange, ScopeKind};
///
...
///
/// ```
/// use reovim_driver_text_syntax::{ContextHierarchy, ScopeRange, ScopeKind};
///
/// let scopes = vec![
