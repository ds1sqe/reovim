...
// OptionChange is now defined in subsys-session and re-exported here for
// backwards compatibility with callers that use `reovim_driver_text_session::api::OptionChange`.
pub use reovim_subsys_session::OptionChange;
