//! `LogRing` — the editor-core log ring (LOG6, 9.5 §8).
//!
...
///
/// ```rust
/// use reovim_editor_core::log::ring::MAX_ENTRY_BYTES;
...
///
/// ```rust
/// use reovim_editor_core::log::ring::MIN_RING_CAPACITY;
...
/// One entry in the editor-core log ring (LOG6).
///
...
/// use reovim_editor_core::log::ring::LogEntry;
/// use reovim_uapi::abi::error::LogLevel;
///
/// let entry = LogEntry {
///     level: LogLevel::Info,
///     line: Bytes::try_from_slice(b"[    0.000001] editor-core boot: test\n").unwrap(),
/// };
...
/// The editor-core log ring (LOG6, 9.5 §8).
///
...
impl LogRing {
    ...
    /// ```no_run
    /// use reovim_editor_core::log::ring::LogRing;
    /// use reovim_editor_core::event_bus::{DS12Event, BootStageFields, EVT_BOOT_STAGE_OK};
