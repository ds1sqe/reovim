...
//! specifies the single editor-core file sink; multi-sink and rotation are deferred.
...
///
/// ```rust
/// use reovim_editor_core::log::sink::EVT_LOG_SINK_FAIL;
...
///
/// Called by `EditorInit::boot` from `LauncherArgs`. Tests that construct a
...
/// single editor-core file sink; multi-sink / rotation is deferred.
///
/// # Example
///
/// ```rust,no_run
...
/// use reovim_editor_core::log::sink::FileSink;
...
/// ```rust,no_run
/// // no_run: requires the arch runtime — use the editor-core-selftest bin.
/// use reovim_editor_core::log::sink::stderr_echo;
/// stderr_echo(b"[    0.000001] editor-core boot: test\n");
/// ```
...
///
/// ```rust
/// use reovim_editor_core::log::sink::SinkOpenError;
///
