...
//! mirror of the one editor-core log ring: every byte written here is a rendered
...
///
/// ```rust
/// use reovim_editor_core::log::flush::FLUSH_BUF_CAPACITY;
...
/// use reovim_editor_core::log::flush::ring_tail;
///
...
/// ```rust,no_run
/// // no_run: mutates process-global state — parallel doctests share the process.
/// use reovim_editor_core::log::flush::{ring_tail, update_after_push};
