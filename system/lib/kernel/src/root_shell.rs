...
fn write_boot_proof(daemon: &RootDaemon<'_>) {
    ...
    daemon.write_line("  probe usb-keyboard reports manual_next=type-shell-command");
    ...
    daemon.write_line("  retained dmesg includes probe usb-keyboard manual_next output");
