# Changelog Archive (v0.7.x and Earlier)

This file contains changelog entries for versions 0.7.x and earlier.
For recent changes (0.8.0+), see [CHANGELOG.md](../CHANGELOG.md).
