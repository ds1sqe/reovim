# Changelog Archive (v0.6.x and Earlier)

This file contains changelog entries for versions 0.6.x and earlier.
For recent changes (0.7.x+), see [CHANGELOG.md](../CHANGELOG.md).
