...
//!
//! - **`TuiApp`**: Main event loop with notifications
//! - **`HeadlessClient`**: CI/capture mode without TTY
//! - **Rendering**: Terminal rendering via crossterm
...
//! ```text
//! ┌─────────────────────────────────────────────────────────────┐
//! │  lib/clients/tui/                  (THIS CRATE - Phase 6)   │
//! │    TuiApp, HeadlessClient, Renderer                         │
//! ├─────────────────────────────────────────────────────────────┤
//! │  lib/clients/core/                 (Phase 5)                │
//! │    Connection, Discovery, RpcClient, OutputFormat           │
//! ├─────────────────────────────────────────────────────────────┤
...
use reovim_client_core::ConnectionConfig;
...
// Module declarations - files will be copied in Phase 6.3
pub mod app;
