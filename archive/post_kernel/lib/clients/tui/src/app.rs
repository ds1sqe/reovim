...
pub struct TuiApp {
    ...
    debug_config: Option<crate::TuiDebugConfig>,
...
impl TuiApp {
        ...
        match notification.method.as_str() {
            ...
            LOG_ENTRY => {
                if let Ok(payload) = serde_json::from_value::<LogEntryPayload>(notification.params)
                {
                    ...
                    let entry = crate::log_buffer::TuiLogEntry::new(
    ...
    fn handle_response(&mut self, response: RpcResponse) {
        use crate::{cli_executor::format_query_result, cli_panel::CliResult};
