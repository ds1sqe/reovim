...
use reovim_client_subsys_module::Style;

// Re-export `SyntaxToken` from subsys-module so callers that import
// `reovim_client_subsys_chrome::conceal::SyntaxToken` keep compiling.
pub use reovim_client_subsys_module::types::SyntaxToken;
