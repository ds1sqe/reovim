...
impl reovim_driver_text_session::SessionExtension for MockTextInputSink {
    fn create() -> Self {
        Self
    }
}

impl reovim_driver_text_session::TextInputSink for MockTextInputSink {
...
fn test_resolver_resolve_with_extensions_delegates_to_keymap() {
    ...
    let mut client_ext = reovim_driver_text_session::ExtensionMap::new();
...
fn test_resolver_resolve_with_session_delegates_to_extensions() {
    ...
    impl ModeKeyResolver for SessionResolver {
        ...
        fn resolve_with_extensions(
            ...
            _state: &mut ModeState,
            _input: &ResolveInput<'_>,
            _shared_extensions: &mut reovim_driver_text_session::ExtensionMap,
            _client_extensions: &mut reovim_driver_text_session::ExtensionMap,
        ) -> ResolveResult {
