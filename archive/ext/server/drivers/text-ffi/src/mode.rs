...
//!
//! [`ModeApi`]: reovim_driver_text_session::api::ModeApi
...
use {
    libc::c_char,
    reovim_driver_text_session::api::ModeApi,
...
pub unsafe extern "C" fn reovim_push_mode(mode_id: *const c_char) -> i32 {
    ffi_catch_unwind(AssertUnwindSafe(|| {
        ...
        match with_runtime(|rt| {
            rt.push_mode(mode.clone(), reovim_driver_text_session::TransitionContext::new());
        }) {
            Err(e) => e,
            Ok(()) => REOVIM_OK,
        }
...
pub unsafe extern "C" fn reovim_set_mode(mode_id: *const c_char) -> i32 {
    ffi_catch_unwind(AssertUnwindSafe(|| {
        ...
        match with_runtime(|rt| {
            rt.set_mode(mode.clone(), reovim_driver_text_session::TransitionContext::new());
        }) {
            Err(e) => e,
            Ok(()) => REOVIM_OK,
        }
