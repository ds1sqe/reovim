...
//!
//! ```ignore
//! use reovim_subsys_session::{SessionExtension, ExtensionMap, TextInputSink};
//!
...
///
/// ```ignore
/// use reovim_subsys_session::{SessionExtension, TextInputSink};
///
/// #[derive(Default)]
/// pub struct CmdlineState {
///     pub buffer: String,
...
impl ExtensionMap {
    ...
    /// ```ignore
    /// use std::any::TypeId;
    /// use reovim_subsys_session::ExtensionMap;
    ///
    /// let mut extensions = ExtensionMap::new();
